<template>
<div>
   <v-top title="Paleteebutton"></v-top>
  <div style="text-align:center;padding-top:200px;">
    <mt-palette-button content="+" @expand="main_log('expand')" @expanded="main_log('expanded')" @collapse="main_log('collapse')"
      ...
      style="left:30px;">
      <div class="my-icon-button indexicon icon-popup" @touchstart="sub_log(1)">a</div>
      <div class="my-icon-button indexicon icon-popup" @touchstart="sub_log(2)">b</div>
      <div class="my-icon-button indexicon icon-popup" @touchstart="sub_log(3)">c</div>
    </mt-palette-button>
    <mt-palette-button content="+" @expand="main_log('expand')" @expanded="main_log('expanded')" @collapse="main_log('collapse')"
